...
+ (UIImage *)renderPage:(PDFDoc *)pDoc
                 ...
                 number:(NSUInteger)number
{
    ...
    fz_pixmap *image_pix = renderPixmap(doc,
                                        ...
                                        rect,
                                        1.0);
    CGDataProviderRef imageData = CreateWrappedPixmap(image_pix);
    UIImage *image = newImageWithPixmap(image_pix, screenScale, imageData);
    return image;
}
